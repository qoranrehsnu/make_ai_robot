...
import math
import time
import ast # Required for parsing perception string lists
...
class Mission5EmptyRoom(Node):
    def __init__(self):
        ...
        self.goal_sent = False # To prevent spamming planner
    ...
    def det_cb(self, msg):
        try:
            # Parse python string list "['stopsign']" -> list ['stopsign']
    ...
    def stop(self):
        ...
        # Also cancel planner goal by sending current position? 
        # For now, cmd_vel 0 usually overrides if planner isn't aggressive.
    ...
    def control_loop(self):
        ...
        # ---------- GO TO ROOM 1 ----------
        if self.state == "GO_R1":
            # Use Planner to get there safely
